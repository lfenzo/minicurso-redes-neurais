...
overfit_train(x) = 3/log(x) + 10 - 0.02*x
overfit_test(x) = log(x) - 0.02*x

ideal_train(x) = 3/log(x) - 10 - 0.01*x
ideal_test(x) = log(0.3x) - 0.02x - 11.8

underfit_train(x) = 9/log(x) + 10 - 0.1*x
underfit_test(x) = -(log(x) + 12/0.3x * 10) + 10 #0.01*x
